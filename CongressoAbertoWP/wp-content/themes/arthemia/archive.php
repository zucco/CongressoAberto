<?php get_header(); ?>
	...
	<?php if (have_posts()) : ?>
 	...
 	<?php /* If this is a category archive */ if (is_category()) { ?><h2 class="title">Artigos na categoria: <?php single_cat_title(); ?> </h2>
...
alt="<?php the_title(); ?>" class="left" width="150px"  /></a>
      <?php } ?>
